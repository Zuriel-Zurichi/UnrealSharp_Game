...
[UClass(ClassFlags.Abstract), GeneratedType("CSEngineSubsystem", "UnrealSharp.CSharpForUE.CSEngineSubsystem")]
public partial class UCSEngineSubsystem : UnrealSharp.Engine.UEngineSubsystem
{
    static UCSEngineSubsystem()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("CSEngineSubsystem");
