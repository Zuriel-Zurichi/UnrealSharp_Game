...
[UClass(ClassFlags.Abstract), GeneratedType("CSLocalPlayerSubsystem", "UnrealSharp.CSharpForUE.CSLocalPlayerSubsystem")]
public partial class UCSLocalPlayerSubsystem : UnrealSharp.Engine.ULocalPlayerSubsystem
{
    static UCSLocalPlayerSubsystem()
    {
    ...
    // K2_PlayerControllerChanged
    IntPtr K2_PlayerControllerChanged_NativeFunction;
    static int K2_PlayerControllerChanged_ParamsSize;
    static int K2_PlayerControllerChanged_NewPlayerController_Offset;
    static int K2_PlayerControllerChanged_ReturnValue_Offset;
    
    [UFunction(FunctionFlags.BlueprintEvent), GeneratedType("K2_PlayerControllerChanged")]
    protected virtual bool PlayerControllerChanged(UnrealSharp.Engine.APlayerController newPlayerController)
    {
        unsafe
        {
            ...
            UStructExporter.CallInitializeStruct(K2_PlayerControllerChanged_NativeFunction, ParamsBuffer);
            ObjectMarshaller<UnrealSharp.Engine.APlayerController>.ToNative(IntPtr.Add(ParamsBuffer, K2_PlayerControllerChanged_NewPlayerController_Offset), 0, newPlayerController);
            
            UObjectExporter.CallInvokeNativeFunction(NativeObject, K2_PlayerControllerChanged_NativeFunction, ParamsBuffer);
            
            bool returnValue;
            returnValue = BoolMarshaller.FromNative(IntPtr.Add(ParamsBuffer, K2_PlayerControllerChanged_ReturnValue_Offset), 0);
    ...
    protected virtual bool PlayerControllerChanged_Implementation(UnrealSharp.Engine.APlayerController NewPlayerController)
    {
        return default(bool);
    }
    void Invoke_K2_PlayerControllerChanged(IntPtr buffer, IntPtr returnBuffer)
    {
        unsafe
        {
            UnrealSharp.Engine.APlayerController NewPlayerController =  ObjectMarshaller<UnrealSharp.Engine.APlayerController>.FromNative(IntPtr.Add(buffer, K2_PlayerControllerChanged_NewPlayerController_Offset), 0);
            bool returnValue = PlayerControllerChanged_Implementation(NewPlayerController);
